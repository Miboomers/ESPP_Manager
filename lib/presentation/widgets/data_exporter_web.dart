...
class DataExporter {
    ...
    try {
      ...
      switch (format) {
        case ExportFormat.csv:
          final csvContent = await _generateCSV(transactions);
          bytes = Uint8List.fromList(utf8.encode(csvContent));
          mimeType = 'text/csv';
          break;
        case ExportFormat.excel:
          bytes = await _generateExcel(transactions);
          mimeType = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet';
          break;
        case ExportFormat.json:
          final jsonContent = await _generateJSON(transactions);
  ...
  static Future<String> _generateCSV(List<TransactionModel> transactions) async {
  ...
  static Future<Uint8List> _generateExcel(List<TransactionModel> transactions) async {
  ...
  static Future<String> _generateJSON(List<TransactionModel> transactions) async {
